...
default[:cookbook_qubell_iis][:site][:path]="C:\\inetpub\\wwwroot"
...
default[:cookbook_qubell_iis][:app_name]=""
default[:cookbook_qubell_iis][:app][:virtual_path]="/"
default[:cookbook_qubell_iis][:app][:application_pool]=""
default[:cookbook_qubell_iis][:app][:path]="C:\\inetpub\\wwwroot\"
